...
import { X, CheckCircle2, ArrowRight, Ban } from 'lucide-react'
import type { BankTransaction, Contribution, Expenditure } from '@/lib/types'
...
function scoreMatch(txAmount: number, txDate: string, amount: number, date: string): 'exact' | 'close' | 'partial' | null {
  ...
  if (amountDiff > 10) return null // too far off on amount
          ...
          {suggestions.length > 0 ? (
            ...
            <div className="py-6 text-center">
              ...
              <p className="text-xs text-slate-400 mt-1">
                The amount or date may differ significantly from your records.
              </p>
            </div>
          )}
        </div>
